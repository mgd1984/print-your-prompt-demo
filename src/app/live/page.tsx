...
export default function LivePage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 overflow-hidden pb-safe">
        ...
        <nav className="relative z-10 px-4 sm:px-6 py-4 sm:py-6">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3 sm:space-x-6">
              <Link 
                href="/"
                className="flex items-center text-slate-600 hover:text-slate-900 transition-colors font-medium text-sm sm:text-base"
              >
              ...
              <Link href="/gallery" className="text-slate-600 hover:text-slate-900 transition-colors font-medium text-sm sm:text-base hidden sm:inline">
                Gallery
              </Link>
              <Link 
                href="/admin" 
                className="px-3 sm:px-4 py-2 bg-slate-900 text-white rounded-full hover:bg-slate-800 transition-all duration-200 font-medium text-xs sm:text-sm"
              >
                Admin
              </Link>
            </div>
        ...
        {/* Header Section */}
        <section className="relative z-10 px-4 sm:px-6 pt-4 sm:pt-8 pb-8 sm:pb-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-green-50 border border-green-200 rounded-full text-green-700 text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-600 mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto px-2">
        ...
        <section className="relative z-10 px-4 sm:px-6 pb-12 sm:pb-20">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/60 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-2xl border border-white/20">
              <PromptVoting />
            </div>
          </div>
        </section>
